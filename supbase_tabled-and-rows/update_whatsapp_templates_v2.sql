-- ============================================================
-- SQL Update: Professional & Emoji-Free WhatsApp Message Templates
-- Run in Supabase SQL Editor to update automated notification triggers
-- ============================================================

-- 1. Function to handle status update notifications via DB trigger
...
-- 2. Function to handle new order notifications via DB trigger
