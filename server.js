...
app.use(async (req, res, next) => {
  ...
  res.header(
    ...
    'Content-Type, Authorization, Content-Length, X-Requested-With, x-store-subdomain, X-Store-Subdomain, x-original-host, X-Original-Host, X-Correlation-ID, X-Request-ID, x-impersonate-session, X-Impersonate-Session, x-pos-session-role, X-Pos-Session-Role, Cache-Control, Pragma, Expires'
  );
