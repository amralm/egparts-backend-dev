-- ============================================================
-- SQL Migration: Fix Subscription Limit Trigger (enforce_feature_limit_trigger)
-- Run in Supabase SQL Editor to prevent blocking UPDATE and DELETE,
-- and count actual structural feature counts in real-time.
-- ============================================================
